...
match = input("Enter value for match: ")
mismatch = input("Enter value for mismatch: ")
gap = input("Enter value for gap: ")
gap = int(gap)
pt ={'match': int(match), 'mismatch': int(mismatch), 'gap': gap}
seqA = input("Enter the 1st sequence: ")
seqB = input("Enter the 2nd sequence: ")
